...
```{r gcnorm,fig.show='hide',results='hide',eval=FALSE}
library(gcapc)
...
Alternatively, one could also be interested in the second differential peak from the figure of the previous section. In this case, the differential peak has genomic windows mostly associated with the condition BN.
```{r viz_heatmap2}
# Selecting target differential peak
